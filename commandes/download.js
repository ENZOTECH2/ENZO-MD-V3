...
zokou({
  ...
  try {
    ...
    if (_0x5a2825 && _0x5a2825.length > 0x0) {
      ...
      const _0x4727f9 = await fetch("https://apisku-furina.vercel.app/api/downloader/play?q=${text}&apikey=indradev");
